package com.cts.demo.performancereviewservice.exceptions;
...
public class CustomGlobalExceptionHandler {
	...
	@ExceptionHandler(value = PerformanceNotFound.class)
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(PerformanceNotFound exception,
