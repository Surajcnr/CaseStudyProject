package com.cts.demo.employeeprofileservice.exceptions;
...
public class CustomGlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(EmployeeNotFound exception,
